...
export class NimbusFactory extends Entity {
  constructor(id: string) {
    ...
    this.set("totalVolumeNBU", Value.fromBigDecimal(BigDecimal.zero()));
    ...
    this.set("totalLiquidityNBU", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("txCount", Value.fromBigInt(BigInt.zero()));
  }

  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save NimbusFactory entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type NimbusFactory must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("NimbusFactory", id.toString(), this);
    }
  }

  static load(id: string): NimbusFactory | null {
    return changetype<NimbusFactory | null>(store.get("NimbusFactory", id));
  }
  ...
  get totalVolumeNBU(): BigDecimal {
    let value = this.get("totalVolumeNBU");
    return value!.toBigDecimal();
  }

  set totalVolumeNBU(value: BigDecimal) {
    this.set("totalVolumeNBU", Value.fromBigDecimal(value));
  }
  ...
  get totalLiquidityNBU(): BigDecimal {
    let value = this.get("totalLiquidityNBU");
    return value!.toBigDecimal();
  }

  set totalLiquidityNBU(value: BigDecimal) {
    this.set("totalLiquidityNBU", Value.fromBigDecimal(value));
  }
...
export class Token extends Entity {
  ...
  get derivedNBU(): BigDecimal | null {
    let value = this.get("derivedNBU");
  ...
  set derivedNBU(value: BigDecimal | null) {
    if (!value) {
      this.unset("derivedNBU");
    } else {
      this.set("derivedNBU", Value.fromBigDecimal(<BigDecimal>value));
    }
  }
...
export class Pair extends Entity {
  constructor(id: string) {
    ...
    this.set("reserveNBU", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("reserveUSD", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("trackedReserveNBU", Value.fromBigDecimal(BigDecimal.zero()));
  ...
  get reserveNBU(): BigDecimal {
    let value = this.get("reserveNBU");
    return value!.toBigDecimal();
  }

  set reserveNBU(value: BigDecimal) {
    this.set("reserveNBU", Value.fromBigDecimal(value));
  }
  ...
  get trackedReserveNBU(): BigDecimal {
    let value = this.get("trackedReserveNBU");
    return value!.toBigDecimal();
  }

  set trackedReserveNBU(value: BigDecimal) {
    this.set("trackedReserveNBU", Value.fromBigDecimal(value));
  }
...
export class Bundle extends Entity {
  constructor(id: string) {
    ...
    this.set("nbuPrice", Value.fromBigDecimal(BigDecimal.zero()));
  }
  ...
  get nbuPrice(): BigDecimal {
    let value = this.get("nbuPrice");
    return value!.toBigDecimal();
  }

  set nbuPrice(value: BigDecimal) {
    this.set("nbuPrice", Value.fromBigDecimal(value));
  }
}

export class NimbusDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));

    this.set("date", Value.fromI32(0));
    this.set("dailyVolumeNBU", Value.fromBigDecimal(BigDecimal.zero()));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save NimbusDayData entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type NimbusDayData must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("NimbusDayData", id.toString(), this);
    }
  }

  static load(id: string): NimbusDayData | null {
    return changetype<NimbusDayData | null>(store.get("NimbusDayData", id));
  }
  ...
  get dailyVolumeNBU(): BigDecimal {
    let value = this.get("dailyVolumeNBU");
    return value!.toBigDecimal();
  }

  set dailyVolumeNBU(value: BigDecimal) {
    this.set("dailyVolumeNBU", Value.fromBigDecimal(value));
  }
