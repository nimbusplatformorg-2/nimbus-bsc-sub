...
export class NimbusFactory extends Entity {
  ...
  save(): void {
    ...
    assert(
      ...
      "Cannot save NimbusFactory entity with non-string ID. " +
  ...
  static load(id: string): NimbusFactory | null {
    return store.get("NimbusFactory", id) as NimbusFactory | null;
  }
...
export class Token extends Entity {
  ...
  set derivedNBU(value: BigDecimal | null) {
    if (value === null) {
      ...
      this.set("derivedNBU", Value.fromBigDecimal(value as BigDecimal));
    }
  }
...
export class NimbusDayData extends Entity {
  ...
  save(): void {
    ...
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save NimbusDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
  ...
  static load(id: string): NimbusDayData | null {
    return store.get("NimbusDayData", id) as NimbusDayData | null;
  }
